...
public class BookPageFactory {
	...
	private int m_backColor = 0xffdaccb2; // 背景颜色
	...
	private Paint mPaint;//写内容的笔
	private Paint percentPaint;//百分比
	...
	public void onDraw(Canvas c) {
		...
		c.drawText(strTime, marginWidth, mHeight - 5, percentPaint);
	}
